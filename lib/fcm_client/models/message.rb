...
module FcmClient
  # Message to send by Firebase Cloud Messaging Service. https://firebase.google.com/docs/reference/fcm/rest/v1/projects.messages#Message 
  class Message
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'webpush')
        self.webpush = attributes[:'webpush']
      end
    end
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+?), (?<v_type>.+)>\z/
        ...
        FcmClient.const_get(type).build_from_hash(value)
      end
    end
